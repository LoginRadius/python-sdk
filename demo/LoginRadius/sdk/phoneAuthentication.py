...
class PhoneAuthentication:
    ...
    def register(self, payload, verificationUrl='', smsTemplate='', getLRServerTime=False):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&verificationUrl=' + \
            verificationUrl + '&smsTemplate=' + smsTemplate
        url = self._lr_object.SECURE_API_URL + \
            phoneAuthEndpoint + "register" + "?" + params
        return self._lr_object._post_json(url, payload)

    def login(self, payload, loginUrl='', smsTemplate='', gRecaptchaResponse='', fields='*'):
        # Phone Login (POST)
        params = 'apikey=' + self._lr_object._get_api_key() + '&loginurl=' + loginUrl + '&smstemplate=' + \
            smsTemplate + '&g-recaptcha-response=' + \
            gRecaptchaResponse + '&fields=' + fields
        url = self._lr_object.SECURE_API_URL + \
            phoneAuthEndpoint + "login" + "?" + params
        return self._lr_object._post_json(url, payload)
    ...
    def forgotPassword(self, phone, smsTemplate=''):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&smsTemplate=' + \
            smsTemplate
        url = self._lr_object.SECURE_API_URL + \
            phoneAuthEndpoint + "password/otp?" + params
        return self._lr_object._post_json(url, payload)
    ...
    def resetPassword(self, phone, otp, password, smsTemplate='', resetpasswordemailtemplate=''):
        ...
        payload = {"phone": phone, "otp": otp, "password": password,
                   "smsTemplate": smsTemplate, "resetpasswordemailtemplate": resetpasswordemailtemplate}
