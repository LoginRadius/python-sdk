...
class CustomObject:
    ...
    def create(self, uid, objectName, payload):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
            self._lr_object._get_api_secret() + '&objectname=' + objectName
        url = self._lr_object.SECURE_API_URL + \
            accountEndpoint + uid + "/customobject?" + params
    ...
    def update(self, uid, objectRecordId, objectName, payload, updatetype='partialreplace'):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + self._lr_object._get_api_secret() + \
            '&objectname=' + objectName + '&updatetype=' + updatetype
        url = self._lr_object.SECURE_API_URL + accountEndpoint + \
            uid + "/customobject/" + objectRecordId + "?" + params
    ...
    def getByUID(self, uid, objectName):
        ...
        ), 'apisecret': self._lr_object._get_api_secret(), 'objectname': objectName}
