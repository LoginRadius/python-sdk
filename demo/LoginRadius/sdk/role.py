...
class Role:
    ...
    def create(self, payload):
        # Roles Create (POST)
        params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
            self._lr_object._get_api_secret()
    ...
    def get(self):
        ...
        ), 'apisecret': self._lr_object._get_api_secret()}
    ...
    def assignRole(self, uid, payload):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
            self._lr_object._get_api_secret()
        url = self._lr_object.SECURE_API_URL + roleEndpoint + \
            "account/" + uid + "/role" + "?" + params
    ...
    class Context:
        ...
        def get(self, uid):
            ...
            url = self._lr_object.SECURE_API_URL + \
                roleEndpoint + "account/" + uid + "/rolecontext"
            return self._lr_object._get_json(url, payload)
        ...
        def add(self, uid, payload):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
                self._lr_object._get_api_secret()
            url = self._lr_object.SECURE_API_URL + roleEndpoint + \
                "account/" + uid + "/rolecontext?" + params
            return self._lr_object._put_json(url, payload)
        ...
        def delete(self, uid, rolecontextname):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
                self._lr_object._get_api_secret()
            url = self._lr_object.SECURE_API_URL + roleEndpoint + "account/" + \
                uid + "/rolecontext/" + rolecontextname + "?" + params
            return self._lr_object._delete_json(url, {})
        ...
        def deleteRole(self, uid, rolecontextname, rolenamePayload):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
                self._lr_object._get_api_secret()
            url = self._lr_object.SECURE_API_URL + roleEndpoint + "account/" + \
                uid + "/rolecontext/" + rolecontextname + "/role?" + params
        ...
        def deletePermission(self, uid, rolecontextname, additionalpermissionPayload):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&apisecret=' + \
                self._lr_object._get_api_secret()
            url = self._lr_object.SECURE_API_URL + roleEndpoint + "account/" + uid + \
                "/rolecontext/" + rolecontextname + "/additionalpermission?" + params
