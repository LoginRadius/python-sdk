(function(k){function l(e,a,b){b=b||!1;var c=document.getElementById(e);c.classList.add("lr-ls-loginscreencontainer");if(c)b||(c.innerHTML=""),c.appendChild(a);else if((c=document.getElementsByClassName(e))&&0<c.length)for(e=0;e<c.length;e++)b||(c[e].innerHTML=""),c[e].appendChild(a)}function m(e,a,b){function c(d){window.scrollTo(0,0);document.getElementById("lr-ls-divsuccess").style.display="none";document.getElementById("lr-ls-divisionerror").innerHTML=d[0].Description;document.getElementById("lr-ls-diverror").style.display=
"table-cell";document.getElementById("lr-ls-status-area").style.backgroundColor="#FF1744";document.getElementById("lr-ls-status-area").style.display="table";document.getElementById("lr-ls-status-area").style.position="absolute";1==a.singlepagestyle&&(document.getElementById("lr-ls-status-area").style.top="137px");setTimeout(function(){document.getElementById("lr-ls-status-area").style.display="none"},8E3)}function g(d){window.scrollTo(0,0);document.getElementById("lr-ls-diverror").style.display="none";
document.getElementById("lr-ls-divsuccess").style.display="table-cell";document.getElementById("lr-ls-status-area").style.backgroundColor="#3EA34D";document.getElementById("lr-ls-status-area").style.display="table";document.getElementById("lr-ls-status-area").style.position="absolute";1==a.singlepagestyle&&(document.getElementById("lr-ls-status-area").style.top="137px");setTimeout(function(){document.getElementById("lr-ls-status-area").style.display="none"},8E3)}function h(d){var f=document.createElement("form"),
b=document.createElement("input");f.method="POST";f.action=a.redirecturl&&a.redirecturl.afterlogin?a.redirecturl.afterlogin:window.location.origin;b.type="hidden";b.name="token";b.value=d.access_token;f.appendChild(b);document.body.appendChild(f);f.submit()}function k(){b.$hooks.register("afterFormRender",function(){var d=document.getElementsByClassName("content")[0].offsetHeight,b=document.getElementsByClassName("tab-label")[0],c=window.getComputedStyle(b)||b.currentStyle;b=parseInt(c.borderBottomWidth,
10);b+=parseInt(c.lineHeight,10);c=document.getElementsByClassName("tab")[0].offsetHeight+d;if(a.pagesshown&&!a.login||0==d)a.signup?(d=580,c=d+b):c=d=580;document.getElementsByClassName("lr-ls-logobase")[0].style.minHeight=c.toString()+"px";document.getElementsByClassName("content")[0].style.height=d.toString()+"px";document.getElementsByClassName("content")[1].style.height=d.toString()+"px";document.getElementsByClassName("content")[2].style.height=d.toString()+"px";document.getElementById("Resetpw-content1").style.height=
c.toString()+"px";document.getElementsByClassName("content")[0].style.overflow="auto";document.getElementsByClassName("content")[0].style.overflowX="hidden";document.getElementsByClassName("content")[0].style.width="50%";document.getElementsByClassName("content")[1].style.overflow="auto";document.getElementsByClassName("content")[1].style.overflowX="hidden";document.getElementsByClassName("content")[1].style.width="50%";document.getElementById("lr-ls-logo-place").style.paddingTop=(c/2.5).toString()+
"px"})}function l(){var d={onSuccess:function(d){document.getElementById("lr-ls-divisionsuccess").innerHTML=a.content&&a.content.emailVerifiedMessage?a.content.emailVerifiedMessage:"You have successfully registered, you now may log in with this email";g(d);console.log(d);e(d,"verifyEmail");d.access_token&&h(d)},onError:function(a){c(a);e(a,"verifyEmail")}};b.util.ready(function(){b.init("verifyEmail",d)})}var p={};p.templateName=a.socialsquarestyle?"loginradiuscustom_tmpl2":"loginradiuscustom_tmpl1";
var m={onSuccess:function(a){a.access_token&&h(a);e(a,"socialLogin")},onError:function(a){c(a);e(a,"socialLogin")},container:"sociallogin-container"},r={onSuccess:function(a){document.getElementById("lr-ls-status-area").style.display="none";e(a,"login");a.access_token&&h(a)},onError:function(a){c(a);e(a,"login")},container:"login-container"},t={onSuccess:function(d){g(d);document.getElementById("lr-ls-divisionsuccess").innerHTML=a.content&&a.content.signupandForgotPwrequest?a.content.signupandForgotPwrequest:
"Please check your email!";d.Data&&d.Data.AccountSid&&d.Data.Sid&&(document.getElementById("lr-ls-divisionsuccess").innerHTML=a.content&&a.content.signupandForgotPwrequestPhone?a.content.signupandForgotPwrequestPhone:"Please check your phone!");document.getElementsByName("loginradius-registration")[0]&&document.getElementsByName("loginradius-registration")[0].reset();e(d,"registration");d.access_token&&(document.getElementById("lr-ls-divisionsuccess").innerHTML=a.content&&a.content.emailVerifiedMessage?
a.content.emailVerifiedMessage:"You have successfully registered, you now may log in with this email",h(d))},onError:function(a){c(a);e(a,"registration")},container:"registration-container"},n={container:"forgotpassword-container"},q=!1;n.onSuccess=function(d){g(d);document.getElementById("lr-ls-divisionsuccess").innerHTML=a.content&&a.content.signupandForgotPwrequest?a.content.signupandForgotPwrequest:"Please check your email!";document.getElementsByName("loginradius-forgotpassword")[0]&&document.getElementsByName("loginradius-forgotpassword")[0].reset();
e(d,"forgotPassword");1==q&&setTimeout(function(){window.location.href=a.redirecturl&&a.redirecturl.afterreset?a.redirecturl.afterreset:window.location.origin},100);q=!0};n.onError=function(a){c(a);e(a,"forgotPassword")};var u={container:"resetpassword-container",onSuccess:function(d){g(d);setTimeout(function(){window.location.href=a.redirecturl&&a.redirecturl.afterreset?a.redirecturl.afterreset:window.location.origin},2E3);e(d,"resetPassword")},onError:function(a){c(a);e(a,"resetPassword")}};!a.singlepagestyle&&
960<screen.width&&k();(function(){b.$hooks.register("afterFormRender",function(){document.getElementsByClassName("loginradius-otpsignin")[0]&&(document.getElementsByClassName("loginradius-otpsignin")[0].style.display="none",document.getElementById("loginradius-otpsignin-send-an-otp-to-sign-in").style.display="none");if(document.getElementById("lr-forgotpw-btn")){var a=document.getElementsByClassName("content-loginradius-password")[0];a.parentNode.insertBefore(document.getElementById("lr-forgotpw-btn"),
a.nextSibling)}});a.singlepagestyle&&(document.getElementsByClassName("content")[0].style.paddingBottom="20px")})();b.util.ready(function(){b.customInterface(".interfacecontainerdiv",p);b.init("socialLogin",m);b.init("login",r);b.init("registration",t);b.init("forgotPassword",n);b.init("resetPassword",u)});(function(){var a=b.util.parseQueryString(window.location.href),c=Object.keys(a).map(function(b){return a[b]});if(-1<Object.keys(a)[0].indexOf("vtype")&&"vtoken"==Object.keys(a)[1]&&1<c.length)if(0<=
c[0].indexOf("emailverification"))l();else if("reset"==c[0]){for(i=0;i<document.getElementsByClassName("tab").length;i++)document.getElementsByClassName("tab")[i].style.display="none";document.getElementById("Resetpw-content1").style.display="inherit"}})();b.$hooks.register("registrationSchemaFilter",function(a,b){b&&(document.getElementById("login-container").style.display="none",document.getElementById("interfacecontainerdivL").style.display="none",document.getElementById("lr-ls-sectiondivider").style.display=
"none",document.getElementById("lr-forgotpw-btn").style.display="none")});b.$hooks.register("startProcess",function(){document.getElementById("loader").style.display="block"});b.$hooks.register("endProcess",function(){document.getElementById("loader").style.display="none"});a.language||b.$hooks.call("setButtonsName",{login:"LOG IN",registration:"SIGN UP",forgotPassword:"SEND",resetPassword:"RESET"})}k.LoginRadiusV2&&(LoginRadiusV2.prototype.loginScreen=function(e,a,b){a=a||{};if(a.pagesshown){if(0==
a.pagesshown.length){alert("there is nothing to display, check your options.pagesshown");return}for(var c=0;c<a.pagesshown.length;c++)a[a.pagesshown[c]]=!0}b=b||function(a,b){};c=document.createElement("div");c.innerHTML='<style type="text/css"> .lr-ls-loginscreencontainer * {    margin: 0;    padding: 0;    box-sizing: border-box;    vertical-align: middle;    border-style: hidden;    font-family:'+(a.body&&a.body.fontFamily?'"'+a.body.fontFamily+'",':" ")+' "-apple-system", "system-ui", "Helvetica Neue", "Helvetica", "Arial", "sans-serif";}@media only screen and (max-device-width: 959px) {    .lr-ls-page {        position: relative;        width: 100%;        height: 100vh;        background-color: #FFFFFF;        box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.12);    }    .lr-ls-logobase {        height: 22vw;        background-color:'+
(a.logo&&a.logo.color?a.logo.color:" #F5F5F5")+";    }    #lr-ls-logo-place {        display: block;        margin-left: auto;        margin-right: auto;        width: 50%;        padding-top: 5vw;    }    .lr-ls-tabs {        display: block;        position: relative;    }    .lr-ls-tabs .tab {        width: 50%;        float: left;        display: flex;        flex-direction: row;"+(a.body&&a.body.backgroundColor?"background-color:"+a.body.backgroundColor+";":"background-color: #FFFFFF;")+'    }    .lr-ls-tabs .tab>input[type="radio"] {        position: absolute;        top: -9999px;        left: -9999px;    }    .lr-ls-tabs .tab>label {        width: 50vw;        flex: 1 1 auto;        display: block;        cursor: pointer;        position: relative;        color: #384049;        font-size: 4.28vw;        line-height: 6.13333rem;        text-align: center;        vertical-align: middle;        border-bottom: 0.5rem solid #EEEEEE;    }    .lr-ls-tabs .content {        z-index: 0;        /* or display: none; */        overflow: hidden;        width: 100%;        position: absolute;        top: 6.5rem;        /* this field  determines the height of the line below the label*/        left: 0;        background-color: #FFFFFF;        display: none;        -webkit-transition: all linear 0.3s;        -moz-transition: all linear 0.3s;        -o-transition: all linear 0.3s;        -ms-transition: all linear 0.3s;        transition: all linear 0.3s;        -webkit-transform: translateX(-250px);        -moz-transform: translateX(-250px);        -o-transform: translateX(-250px);        -ms-transform: translateX(-250px);        transform: translateX(-250px);    }    .Resetpw-content {        display: none;'+
(a.singlepagestyle?"":"left:360px")+'    }    .lr-ls-tabs>.tab>[id^="tab"]:checked+label {        top: 0;        border-bottom: 0.5rem solid #BDBDBD;        -webkit-animation: page 0.2s linear;        -moz-animation: page 0.2s linear;        -ms-animation: page 0.2s linear;        -o-animation: page 0.2s linear;        animation: page 0.2s linear;    }    .lr-ls-tabs>.tab>[id^="tab"]:checked~[id^="tab-content"] {'+(a.body&&a.body.backgroundColor?"background-color:"+a.body.backgroundColor+";":"")+
"        z-index: 1;        /* or display: block; */        display: block;        -webkit-transform: translateX(0px);        -moz-transform: translateX(0px);        -o-transform: translateX(0px);        -ms-transform: translateX(0px);        transform: translateX(0px);        -webkit-transition: all ease-out 0.8s 0.1s;        -moz-transition: all ease-out 0.8s 0.1s;        -o-transition: all ease-out 0.8s 0.1s;        -ms-transition: all ease-out 0.8s 0.1s;        transition: all ease-out 0.8s 0.1s;        overflow: hidden;    }    .greeting {        margin-top: 4vh;        width: 91vw;        font-size: 5vw;        margin-bottom: 3rem;        line-height: 4rem;        color: #424242;    }    #lr-ls-sectiondivider {        margin-top: 3.2rem;        display: block;        margin-left: auto;        margin-right: auto;        height: 1.5rem;        text-align: center;        color: #424242;        font-size: 5vw;        line-height: 5rem;    }"+
(a.socialsquarestyle?"    .social-login-b-options {        margin-top: 6vh;        width: 91vw;        text-align: center;        font-size: 5vw;        font-weight: 400;        -webkit-animation: slide-up 1s ease-out;        -moz-animation: slide-up 1s ease-out;    }    .social-login-b-options .lr-sl-shaded-brick-button {        height: 8rem;        width: 8rem;        border-radius: 0.5rem;        overflow: hidden;        margin-top: 2.5vw;        position: relative;        border: 1px solid rgba(0, 0, 0, 0.1);        text-align: left;        text-decoration: none;        color: white;        box-shadow: 0 0 1px 0 rgba(0, 0, 0, 0.12), 0 1px 1px 0 rgba(0, 0, 0, 0.24), 0 0 8px 0 rgba(0, 0, 0, 0.12), 0 2px 2px 0 rgba(0, 0, 0, 0.24);    }    .social-login-b-options .lr-sl-shaded-brick-button .lr-sl-icon {        top: 0;        left: 0;        display: inline-block;        position: absolute;    }    .lr-provider-label {        margin-top: 8px;        display: inline-block;    }":
"    .social-login-b-options {        margin-top: 6vh;        width: 91vw;        text-align: center;        font-size: 5vw;        font-weight: 400;        -webkit-animation: slide-up 1s ease-out;        -moz-animation: slide-up 1s ease-out;    }    .social-login-b-options .lr-sl-shaded-brick-button {        height: 8rem;        width: 100%;        border-radius: 0.5rem;        overflow: hidden;        margin-top: 2.5vw;        position: relative;        border: 1px solid rgba(0, 0, 0, 0.1);        text-align: left;        text-decoration: none;        color: white;        padding: 2rem 0 0.8rem 8rem;        box-shadow: 0 0 1px 0 rgba(0, 0, 0, 0.12), 0 1px 1px 0 rgba(0, 0, 0, 0.24), 0 0 8px 0 rgba(0, 0, 0, 0.12), 0 2px 2px 0 rgba(0, 0, 0, 0.24);    }    .social-login-b-options .lr-sl-shaded-brick-button .lr-sl-icon {        top: 0;        left: 0;        display: inline-block;        position: absolute;    }    .lr-provider-label {        display: block;    }")+
'    .lr-sl-icon:before {        width: 8rem;        height: 8rem;        background: url("http://cdn.loginradius.com/hub/prod/v1/hosted-page-default-images/icon-sprite-32.png");        background-image: linear-gradient(transparent, transparent), url("http://cdn.loginradius.com/hub/prod/v1/hosted-page-default-images/icon-sprite.svg"), none;        background-size: 100% 3600%;        background-position: 0 0;        margin-top: -4px;        margin-top: -0.4rem;    }    .lr-ls-status-area {        margin-left: auto;        margin-right: auto;        width: 100vw;        display: none;        z-index: 2;    }    .lr-iconsuccess {        font-family: arial;        -ms-transform: scaleX(-1) rotate(-35deg); /* IE 9 */        -webkit-transform: scaleX(-1) rotate(-35deg); /* Chrome, Safari, Opera */        transform: scaleX(-1) rotate(-35deg);        float: left;        margin-right: 6px;    }    .lr-iconerror {        text-align: center;        font-family: sans-serif;        float: left;        margin-right: 6px;    }    .lr-ls-divsuccess {        display: none;        padding: 0.8rem;        border: 1px solid #3EA34D;        color: #FFFFFF;        font-size: 4vw;        line-height: 3rem;        font-weight: 600;        vertical-align: middle;    }    .lr-ls-diverror {        display: none;        padding: 0.8rem;        border: 1px solid #FF1744;        color: #FFFFFF;        font-size: 4vw;        line-height: 3rem;        font-weight: 600;        vertical-align: middle;    }     ::-webkit-input-placeholder {        font-size: 4vw;        line-height: 100%;    }    .loginradius--form-element-content {        text-align: left;        margin-bottom: 4rem;        margin-bottom: 6.5vw;    }    #login-container .loginradius--form-element-content, #registration-container .loginradius--form-element-content, #forgotpassword-container .loginradius--form-element-content, #resetpassword-container .loginradius--form-element-content {        padding-left: 3rem;    }    .loginradius--form-element-content label {        color:'+
(a.body&&a.body.textColor?a.body.textColor:"#616161")+';        font-size: 5vw;        line-height: 4rem;    }    #login-container,    #registration-container,    #forgotpassword-container {        margin-top: 5rem;        width: 91vw;        z-index: 0;    }    #forgotpassword-container {        margin-top: 16px;    }    input .invalid {        border: 1px solid #FF1744;        background-color: #F5F5F5;    }    select {           height: 5rem;           background-color: #F5F5F6;           font-size: 5vw;           font-weight: 300;           padding: 8px;           margin-left: 20px;     }    textarea,    input[type="password"],    input[type="text"] {        margin-top: 4px;        height: 5rem;        width: 91vw;        background-color:'+
(a.input&&a.input.background?a.input.background:" #F5F5F5")+';        border-style: hidden;        font-size: 5vw;        font-weight: 300;        line-height: 10rem;        padding: 8px;        -webkit-box-sizing: border-box;        box-sizing: border-box;    }    input[type="submit"] {        margin-top: 2.5rem;        margin-top: 4.2vw;        color: #FFFFFF;        font-size: 5vw;        text-align: center;        letter-spacing: 0.2rem;        cursor: pointer;    }    .content-loginradius-stayLogin {        margin-top: 2rem;        display: flex;    }    input[type="checkbox"] {        height: 3rem;        width: 3rem;        border: 1px solid #9E9E9E;        vertical-align: middle;    }    .content-loginradius-stayLogin label {        height: 3rem;        color:'+
(a.body&&a.body.textColor?a.body.textColor:"#616161")+";        font-size: 4.5vw;        line-height: 3rem;    }    #lr-forgotpw-btn {        color:"+(a.body&&a.body.textColor?a.body.textColor:"#616161")+';        cursor: pointer;        font-size: 4.5vw;        line-height: 3rem;        height: 3rem;        right: 4.5vw;        bottom: 26.5vw;        float: right;    }    #loginradius-submit-login {        margin-right: auto;        height: 16vw;        width: 91vw;        background-color: #35a8ff;        box-shadow: 0 2px 5px 0 rgba(0, 0, 0, .16), 0 2px 10px 0 rgba(0, 0, 0, .12);        outline: none;        border-radius: 1rem 1rem 1rem 1rem;    }    [id *= "loginradius-submit-"] {        margin-left: 3rem;        margin-right: auto;        height: 16vw;        width: 91vw;        background-color: #35a8ff;        box-shadow: 0 2px 5px 0 rgba(0, 0, 0, .16), 0 2px 10px 0 rgba(0, 0, 0, .12);        outline: none;        border-radius: 1rem 1rem 1rem 1rem;    }    [id *= "loginradius-submit-"]:hover,    #loginradius-submit-reset-password:hover {        filter: brightness(98%);        transition: color 400ms;    }    [id *= "loginradius-submit-"]:active {        filter: brightness(85%);        transition: color 400ms;    }    #forgotPW {        height: 17px;        color: #424242;        font-size: 4vw;        line-height: 17px;        text-align: center;        text-decoration: none;        position: absolute;    }    #reset-password {        height: 5rem;        color: #414141;        font-size: 6vw;        font-weight: 300;        line-height: 37px;    }    .loginradius-validation-message {        color: #FF1744;        font-size: 3.28vw;        line-height: 2rem;        margin-top: 1rem;    }    @-webkit-keyframes slide-up {        0% {            opacity: 0;            -webkit-transform: translateY(-100%);        }        100% {            opacity: 1;            -webkit-transform: translateY(0);        }    }    @-moz-keyframes slide-up {        0% {            opacity: 0;            -moz-transform: translateY(-100%);        }        100% {            opacity: 1;            -moz-transform: translateY(0);        }    }    .lr-ls-pageloader {        display: none;        z-index: 999;        width: 100%;        height: 100%;        position: fixed;        top: 0;        right: 0;        bottom: 0;        left: 0;        background-color: rgba(0, 0, 0, .5);    }    .lr-ls-page-loadwheel {        width: 15vw;        height: 15vw;        margin-top: -7.5vw;        margin-left: -7.5vw;        position: absolute;        top: 50%;        left: 50%;        border-width: 30px;        border-radius: 50%;        border: 10px solid #f3f3f3;        border-radius: 50%;        border-top: 10px solid #3498db;        -webkit-animation: spin 2s linear infinite;        /* Safari */        animation: spin 2s linear infinite;    }    @-webkit-keyframes spin {        0% {            -webkit-transform: rotate(0deg);        }        100% {            -webkit-transform: rotate(360deg);        }    }    @keyframes spin {        0% {            transform: rotate(0deg);        }        100% {            transform: rotate(360deg);        }    }}@media only screen and (min-device-width: 960px) {    .lr-ls-page {        position: relative;        width:'+
(a.singlepagestyle?"360px;":"720px;")+"        border-radius: 6px 6px 0 0;        background-color: #FFFFFF;        box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.12);        margin: 5% auto;    }    .lr-ls-logobase {"+(a.singlepagestyle?"        height: 90px;":"        float: left;")+"        width: 360px;"+(a.singlepagestyle?"        border-radius: 6px 6px 0 0;":"        border-radius: 6px 0 0 6px;")+"        background-color:"+(a.logo&&a.logo.color?a.logo.color:" #F5F5F5")+
";    }    #lr-ls-logo-place {        display: block;        margin-left: auto;        margin-right: auto;        width: 50%;        padding-top: 23.67px;    }    .lr-ls-tabs {        display: block;        position: relative;        background-color: #FFFFFF;    }    .lr-ls-tabs .tab {        float: left;        display: flex;        flex-direction: row;"+(a.body&&a.body.backgroundColor?"background-color:"+a.body.backgroundColor+";":"background-color: #FFFFFF;")+'    }    .lr-ls-tabs .tab>input[type="radio"] {        position: absolute;        top: -9999px;        left: -9999px;    }    .lr-ls-tabs .tab>label {        width: 180px;        flex: 1 1 auto;        display: block;        cursor: pointer;        position: relative;        color: #384049;        font-size: 15px;        line-height: 38px;        text-align: center;        vertical-align: middle;        border-bottom: 4px solid #EEEEEE;    }    .lr-ls-tabs .content {        margin-top: 14px;        /* this field  determines the height of the line below the label*/        z-index: 0;        /* or display: none; */        overflow: hidden;        width: 360px;        position: absolute;        top: 27px;'+
