...
print '<script src="//cdn.loginradius.com/hub/prod/js/LoginRadiusRaaS.js"></script>'
print '<script type="text/javascript">var raasoption = {};raasoption.apikey = "' + API_KEY +'";raasoption.V2Recaptcha = true;raasoption.emailVerificationUrl = window.location;raasoption.forgotPasswordUrl = window.location;raasoption.templatename = "loginradiuscustom_tmpl";raasoption.inFormvalidationMessage = true;raasoption.hashTemplate = true;</script>'
print '<script src="LoginRadiusFrontEnd.js"></script>'
print '</head>'
print '<body>'
print '<script type="text/html" id="loginradiuscustom_tmpl"><a class="lr-provider-label" href="javascript:void(0)" onclick="return  $LR.util.openWindow(\'<#= Endpoint #>&is_access_token=true&callback=<#= window.location #>\');" title="<#= Name #>" alt="Sign in with <#=Name#>">Login with <#=Name#></a><br></script>'
