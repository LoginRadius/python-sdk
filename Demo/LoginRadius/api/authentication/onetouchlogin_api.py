...
class OneTouchLoginApi:
    ...
    def one_touch_login_by_email(
        self,
        one_touch_login_by_email_model,
        one_touch_login_email_template=None,
        redirecturl=None,
        ...
        if one_touch_login_by_email_model is None:
            raise Exception(
                self._lr_object.get_validation_message("one_touch_login_by_email_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, one_touch_login_by_email_model
        )

    def one_touch_login_by_phone(
        self, one_touch_login_by_phone_model, sms_template=None
    ):
        ...
        if one_touch_login_by_phone_model is None:
            raise Exception(
                self._lr_object.get_validation_message("one_touch_login_by_phone_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, one_touch_login_by_phone_model
        )

    def one_touch_login_otp_verification(
        self, otp, phone, fields='', sms_template=None
    ):
    ...
    def one_touch_email_verification(
        self, verification_token, welcome_email_template=None
    ):
