...
class PhoneAuthenticationApi:
    ...
    def login_by_phone(
        self, phone_authentication_model, fields='', login_url=None, sms_template=None
    ):
    ...
    def reset_password_by_phone_otp(self, reset_password_by_otp_model):
        ...
        if reset_password_by_otp_model is None:
            raise Exception(
                self._lr_object.get_validation_message("reset_password_by_otp_model")
            )
        ...
        resource_path = "identity/v2/auth/password/otp"
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, reset_password_by_otp_model
        )

    def phone_verification_by_otp(self, otp, phone, fields='', sms_template=None):
    ...
    def phone_verification_otp_by_access_token(
        self, access_token, otp, sms_template=None
    ):
    ...
    def phone_resend_verification_otp_by_token(
        self, access_token, phone, sms_template=None
    ):
    ...
    def user_registration_by_phone(
        self,
