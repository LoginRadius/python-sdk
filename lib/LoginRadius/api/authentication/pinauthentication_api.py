...
class PINAuthenticationApi:
    ...
    def pin_login(self, login_by_pin_model, session_token):
        ...
        if login_by_pin_model is None:
            raise Exception(
                self._lr_object.get_validation_message("login_by_pin_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, login_by_pin_model
        )

    def send_forgot_pin_email_by_email(
        self, forgot_pin_link_by_email_model, email_template=None, reset_pin_url=None
    ):
        ...
        if forgot_pin_link_by_email_model is None:
            raise Exception(
                self._lr_object.get_validation_message("forgot_pin_link_by_email_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, forgot_pin_link_by_email_model
        )

    def send_forgot_pin_email_by_username(
        self,
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, forgot_pin_link_by_user_name_model
        )
    ...
    def reset_pin_by_reset_token(self, reset_pin_by_reset_token):
        ...
        if reset_pin_by_reset_token is None:
            raise Exception(
                self._lr_object.get_validation_message("reset_pin_by_reset_token")
            )
        ...
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, reset_pin_by_reset_token
        )

    def reset_pin_by_email_and_security_answer(
        self, reset_pin_by_security_question_answer_and_email_model
    ):
    ...
    def reset_pin_by_username_and_security_answer(
        self, reset_pin_by_security_question_answer_and_username_model
    ):
    ...
    def reset_pin_by_phone_and_security_answer(
        self, reset_pin_by_security_question_answer_and_phone_model
    ):
    ...
    def send_forgot_pin_sms_by_phone(
        self, forgot_pin_otp_by_phone_model, sms_template=None
    ):
        ...
        if forgot_pin_otp_by_phone_model is None:
            raise Exception(
                self._lr_object.get_validation_message("forgot_pin_otp_by_phone_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, forgot_pin_otp_by_phone_model
        )
    ...
    def change_pin_by_access_token(self, access_token, change_pin_model):
        ...
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, change_pin_model
        )
    ...
    def reset_pin_by_phone_and_otp(self, reset_pin_by_phone_and_otp_model):
        ...
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, reset_pin_by_phone_and_otp_model
        )
    ...
    def reset_pin_by_email_and_otp(self, reset_pin_by_email_and_otp_model):
        ...
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, reset_pin_by_email_and_otp_model
        )
    ...
    def reset_pin_by_username_and_otp(self, reset_pin_by_username_and_otp_model):
        ...
        return self._lr_object.execute(
            "PUT", resource_path, query_parameters, reset_pin_by_username_and_otp_model
        )
    ...
    def set_pin_by_pin_auth_token(self, pin_required_model, pin_auth_token):
        ...
        if pin_required_model is None:
            raise Exception(
                self._lr_object.get_validation_message("pin_required_model")
            )
        ...
        return self._lr_object.execute(
            "POST", resource_path, query_parameters, pin_required_model
        )
