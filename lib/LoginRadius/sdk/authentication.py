...
class Authentication:
    ...
    def register(self, payload, verificationUrl='', emailTemplate='', getLRServerTime=False):
        ...
        payload['sott'] = sott
        params = 'apikey=' + self._lr_object._get_api_key() + '&verificationUrl=' + \
            verificationUrl + '&emailtemplate=' + emailTemplate
    ...
    def getServerTime(self, timeDifference=''):
        ...
        if timeDifference == '':
            timeDifference = '10'
        payload = {'apikey': self._lr_object._get_api_key(),
    ...
    def captchaRegister(self, payload, verificationUrl='', emailTemplate=''):
        params = 'apikey=' + self._lr_object._get_api_key() + '&verificationUrl=' + \
            verificationUrl + '&emailTemplate=' + emailTemplate
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + "register/captcha" + "?" + params
        return self._lr_object._post_json(url, payload)
    ...
    def deleteAccountByEmailConfirmation(self, access_token, deleteUrl='', emailTemplate=''):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + access_token + \
            '&verificationUrl=' + deleteUrl + '&emailTemplate=' + emailTemplate
    ...
    def forgotPassword(self, email, resetPasswordUrl, emailTemplate=''):
        ...
        payload = {'email': email}
        params = 'apikey=' + self._lr_object._get_api_key() + '&resetPasswordUrl=' + \
            resetPasswordUrl + '&emailTemplate=' + emailTemplate
    ...
    def resetPassword(self, payload):
        ...
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + "password/reset" + "?" + params
        return self._lr_object._put_json(url, payload)
    ...
    def resetPasswordBySecurityAnswerAndEmail(self, securityanswer, email, password):
        ...
        params = 'apikey=' + self._lr_object._get_api_key()
        url = self._lr_object.SECURE_API_URL + authEndpoint + \
            "password/securityanswer" + "?" + params
        return self._lr_object._put_json(url, payload)
    ...
    def updateSecurityQuestionByAccessToken(self, access_token, payload):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
            access_token
        url = self._lr_object.SECURE_API_URL + authEndpoint + "account?" + params
        return self._lr_object._put_json(url, payload)
    ...
    def changePassword(self, access_token, oldpassword, newpassword):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
            access_token
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + "password/change" + "?" + params
        return self._lr_object._put_json(url, payload)
    ...
    def addEmail(self, access_token, email, emailtype, verificationUrl='', emailTemplate=''):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + access_token + \
            '&emailTemplate=' + emailTemplate + '&verificationUrl=' + verificationUrl
    ...
    def getVerifyEmail(self, verificationToken, url='', welcomeemailtemplate=''):
        # Verify Email (GET)
        payload = {'apikey': self._lr_object._get_api_key(), 'verificationToken': verificationToken,
                   'url': url, 'welcomeemailtemplate': welcomeemailtemplate}
    ...
    def verifyEmailbyOTP(self, payload, url='', welcomeemailtemplate=''):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&url=' + url + \
    ...
    def accountLink(self, access_token, candidateToken):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
            access_token
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + "socialIdentity" + "?" + params
        return self._lr_object._put_json(url, payload)
    ...
    def securityQuestionByToken(self, access_token):
        ...
        payload = {'apikey': self._lr_object._get_api_key(),
                   'access_token': access_token}
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + 'securityquestion/accesstoken'
        return self._lr_object._get_json(url, payload)
    ...
    def securityQuestionByUsername(self, username):
        ...
        payload = {'apikey': self._lr_object._get_api_key(),
                   'username': username}
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + 'securityquestion/username'
        return self._lr_object._get_json(url, payload)
    ...
    def validateSecretCode(self, payload):
        ...
        params = 'apikey=' + self._lr_object._get_api_key()
        url = self._lr_object.SECURE_API_URL + authEndpoint + \
            "registrationdata/validatecode" + "?" + params
        return self._lr_object._post_json(url, payload)

    def authGetRegistrationDataServer(self, datasourcetype, parentid='', skip='', limit=''):
        # Get Registration Data Server (GET)
        params = 'apikey=' + self._lr_object._get_api_key() + '&parentid=' + parentid + \
            '&skip=' + skip + '&limit=' + limit
        url = self._lr_object.SECURE_API_URL + authEndpoint + \
            "registrationdata/" + datasourcetype + "?" + params
        return self._lr_object._get_json(url, {})
    ...
    def privacyPolicyAccept(self, access_token):
        ...
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
            access_token
        url = self._lr_object.SECURE_API_URL + authEndpoint + \
            'privacypolicy/accept' + "?" + params
        return self._lr_object._get_json(url, {})

    def sendWelcomeEmail(self, access_token, welcomeemailtemplate=''):
        # Send Welcome Email (GET)
        params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
            access_token + '&welcomeemailtemplate=' + welcomeemailtemplate
        url = self._lr_object.SECURE_API_URL + authEndpoint + \
            'account/sendwelcomeemail' + "?" + params
        return self._lr_object._get_json(url, {})

    def deleteAccount(self, deletetoken):
        # Delete Account (GET)
        params = 'apikey=' + self._lr_object._get_api_key() + '&deletetoken=' + \
            deletetoken
        url = self._lr_object.SECURE_API_URL + \
            authEndpoint + 'account/delete' + "?" + params
        return self._lr_object._get_json(url, {})
    ...
    class Login:
        ...
        def byEmail(self, payload, verificationUrl='', loginUrl='', emailTemplate='', gRecaptchaResponse='', fields='*'):
            # Login by Email (POST)
            params = 'apikey=' + self._lr_object._get_api_key() + '&verificationurl=' + verificationUrl + '&loginurl=' + \
                loginUrl + '&emailtemplate=' + emailTemplate + \
                '&g-recaptcha-response=' + gRecaptchaResponse + '&fields=' + fields
        ...
        def byOTP(self, phone, otp, smstemplate=''):
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'phone': phone, 'otp': otp, 'smstemplate': smstemplate}
            url = self._lr_object.SECURE_API_URL + authEndpoint + 'login'
            return self._lr_object._get_json(url, payload)

        def byBackupCode(self, secondfactorauthenticationtoken, backupcode):
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'secondfactorauthenticationtoken': secondfactorauthenticationtoken, 'backupcode': backupcode}
        ...
        def passwordlessLoginByEmail(self, email, oneclicksignintemplate='', verificationurl=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'email': email, 'oneclicksignintemplate': oneclicksignintemplate, 'verificationurl': verificationurl}
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + 'login/passwordlesslogin/email'
            return self._lr_object._get_json(url, payload)
        ...
        def passwordlessLoginByUsername(self, username, oneclicksignintemplate='', verificationurl=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(), 'username': username,
                       'oneclicksignintemplate': oneclicksignintemplate, 'verificationurl': verificationurl}
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + 'login/passwordlesslogin/email'
            return self._lr_object._get_json(url, payload)
        ...
        def passwordlessLoginVerification(self, verificationtoken, welcomeemailtemplate=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'verificationtoken': verificationtoken, 'welcomeemailtemplate': welcomeemailtemplate}
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'login/passwordlesslogin/email/verify'
            return self._lr_object._get_json(url, payload)

        def passwordlessLoginVerifyOTP(self, payload, smstemplate=''):
            # Phone Login Using One Time Passcode (PUT)
            params = '?apikey=' + self._lr_object._get_api_key() + '&smstemplate=' + \
                smstemplate
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'login/passwordlesslogin/otp/verify' + params
            return self._lr_object._put_json(url, payload)

        def passwordlessLoginSendOTP(self, phone, smstemplate=''):
            # Phone Send One time Passcode (GET)
            params = '?apikey=' + self._lr_object._get_api_key() + '&phone=' + phone + \
                '&smstemplate=' + smstemplate
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'login/passwordlesslogin/otp' + params
            return self._lr_object._get_json(url, {})
        ...
        def smartLoginByEmail(self, email, clientguid, smartloginemailtemplate='', welcomeemailtemplate='', redirecturl=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(), 'email': email, 'clientguid': clientguid, 'redirecturl': redirecturl,
                       'smartloginemailtemplate': smartloginemailtemplate, 'welcomeemailtemplate': welcomeemailtemplate}
        ...
        def smartLoginByUsername(self, username, clientguid, smartloginemailtemplate='', welcomeemailtemplate='', redirecturl=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(), 'username': username, 'clientguid': clientguid, 'redirecturl': redirecturl,
                       'smartloginemailtemplate': smartloginemailtemplate, 'welcomeemailtemplate': welcomeemailtemplate}
            url = self._lr_object.SECURE_API_URL + authEndpoint + 'login/smartlogin'
            return self._lr_object._get_json(url, payload)
        ...
        def oneTouchLoginByEmail(self, email, clientguid, name='', redirecturl='', noregistrationemailtemplate='', welcomeemailtemplate=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(), 'email': email, 'clientguid': clientguid, 'name': name, 'redirecturl': redirecturl,
                       'noregistrationemailtemplate': noregistrationemailtemplate, 'welcomeemailtemplate': welcomeemailtemplate}
        ...
        def oneTouchLoginByPhone(self, phone, clientguid, name='', smstemplate=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'phone': phone, 'name': name, 'smstemplate': smstemplate}
        ...
        def oneTouchEmailVerification(self, verificationtoken, welcomeemailtemplate=''):
            ...
            params = '?apikey=' + self._lr_object._get_api_key() + '&verificationtoken=' + \
                verificationtoken + '&welcomeemailtemplate=' + welcomeemailtemplate
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + "email/smartlogin" + params
            return self._lr_object._get_json(url, {})
        ...
        def oneTouchOtpVerification(self, otp, phone, smstemplate=''):
            ...
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                "onetouchlogin/phone/verify" + "?" + params
            return self._lr_object._put_json(url, payload)
    ...
    class Profile:
        ...
        def updateByToken(self, access_token, payload, verificationUrl='', emailTemplate='', isNullSupport=False, fields='*'):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + access_token + '&verificationUrl=' + \
                verificationUrl + '&emailTemplate=' + emailTemplate + \
                '&nullsupport=' + str(isNullSupport) + "&fields=" + fields
            url = self._lr_object.SECURE_API_URL + authEndpoint + "account" + "?" + params
            return self._lr_object._put_json(url, payload)
    ...
    class CustomObject:
        ...
        def create(self, access_token, objectName, payload):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token + '&objectName=' + objectName
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + "customobject" + "?" + params
            return self._lr_object._post_json(url, payload)
        ...
        def update(self, access_token, objectRecordId, objectName, payload, updatetype='partialreplace'):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token + '&objectname=' + objectName + '&updatetype=' + updatetype
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                "customobject/" + objectRecordId + "?" + params
            return self._lr_object._put_json(url, payload)

        def getByToken(self, access_token, objectName):
            # Custom Object by Token (GET)
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'access_token': access_token, 'objectname': objectName}
        ...
        def getByID(self, access_token, objectRecordId, objectName):
            ...
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + "customobject/" + objectRecordId
            return self._lr_object._get_json(url, payload)
    ...
    class TwoFactor:
        ...
        def byToken(self, access_token, smsTemplate2FA=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(
            ), 'access_token': access_token, 'smsTemplate2FA': smsTemplate2FA}
        ...
        def phoneLogin(self, phone, password, loginUrl='', verificationUrl='', smsTemplate='', smsTemplate2FA='', emailTemplate=''):
            ...
            params = '?apikey=' + self._lr_object._get_api_key() + '&loginUrl=' + loginUrl + '&verificationUrl=' + verificationUrl + \
                '&smsTemplate=' + smsTemplate + '&smsTemplate2FA=' + \
                smsTemplate2FA + '&emailTemplate=' + emailTemplate
        ...
        def emailLogin(self, email, password, loginUrl='', verificationUrl='', emailTemplate='', smsTemplate2FA=''):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&loginUrl=' + loginUrl + '&verificationUrl=' + \
                verificationUrl + '&emailTemplate=' + \
                emailTemplate + '&smsTemplate2FA=' + smsTemplate2FA
            url = self._lr_object.SECURE_API_URL + authEndpoint + "login/2fa?" + params
            return self._lr_object._post_json(url, payload)
        ...
        def usernameLogin(self, username, password, loginUrl='', verificationUrl='', emailTemplate='', smsTemplate2FA='', emailTemplate2FA=''):
            ...
            params = '?apikey=' + self._lr_object._get_api_key() + '&loginUrl=' + loginUrl + '&verificationUrl=' + verificationUrl + \
                '&emailTemplate=' + emailTemplate + '&smsTemplate2FA=' + \
                smsTemplate2FA + '&emailTemplate2FA=' + emailTemplate2FA
            url = self._lr_object.SECURE_API_URL + authEndpoint + "login/2fa" + params
            return self._lr_object._post_json(url, payload)
        ...
        def updatePhone(self, secondFactorAuthenticationToken, phoneNo2FA, smsTemplate2FA=''):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&secondFactorAuthenticationToken=' + \
                secondFactorAuthenticationToken + '&smsTemplate2FA=' + smsTemplate2FA
            url = self._lr_object.SECURE_API_URL + authEndpoint + "login/2FA" + "?" + params
            return self._lr_object._put_json(url, payload)
        ...
        def verifyGoogleAuth(self, secondFactorAuthenticationToken, googleAuthenticatorCode, otp, smsTemplate2FA=''):
            ...
            payload = {'apikey': self._lr_object._get_api_key(), 'secondFactorAuthenticationToken': secondFactorAuthenticationToken,
                       'googleAuthenticatorCode': googleAuthenticatorCode, 'otp': otp, 'smsTemplate2FA': smsTemplate2FA}
        ...
        def updatePhoneByToken(self, access_token, phoneNo2FA, smsTemplate2FA=''):
            ...
            payload = {'phoneNo2FA': phoneNo2FA}
            params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token + '&smsTemplate2FA=' + smsTemplate2FA
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + "account/2FA" + "?" + params
            return self._lr_object._put_json(url, payload)
        ...
        def removeAuthByToken(self, access_token, authenticator):
            ...
            params = 'apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                "account/2FA/authenticator" + "?" + params
            return self._lr_object._delete_json(url, payload)
        ...
        def validateGoogleAuthCode(self, googleauthenticatorcode, secondfactorauthenticationtoken, smstemplate2fa=''):
            ...
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'login/2fa/verification/googleauthenticatorcode' + param
            return self._lr_object._put_json(url, payload)

        def updateByAccessToken(self, access_token, googleauthenticatorcode, smstemplate=''):
            # Update MFA by Access Token (PUT)
            param = '?apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token + '&smstemplate=' + smstemplate
            payload = {'googleauthenticatorcode': googleauthenticatorcode}
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'account/2fa/verification/googleauthenticatorcode' + param
            return self._lr_object._put_json(url, payload)
        ...
        def updateSetting(self, access_token, payload):
            ...
            param = '?apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'account/2fa/verification/otp' + param
            return self._lr_object._put_json(url, payload)
        ...
        def reAuth(self, access_token, smstemplate2fa=''):
            ...
            param = '?apikey=' + self._lr_object._get_api_key() + '&access_token=' + \
                access_token + '&smstemplate2fa=' + smstemplate2fa
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + 'account/reauth/2fa' + param
            return self._lr_object._get_json(url, {})
        ...
        def reAuthByGoogleAuthCode(self, access_token, googleauthenticatorcode):
            ...
            payload = {'googleauthenticatorcode': googleauthenticatorcode}
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'account/reauth/2fa/googleauthenticatorcode' + param
            return self._lr_object._put_json(url, payload)
        ...
        def reAuthByBackupCode(self, access_token, backupcode):
            ...
            payload = {'backupcode': backupcode}
            url = self._lr_object.SECURE_API_URL + authEndpoint + \
                'account/reauth/2fa/backupcode' + param
            return self._lr_object._put_json(url, payload)
        ...
        def reAuthByOTP(self, access_token, otp, smstemplate2fa=''):
            ...
            payload = {'otp': otp}
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + 'account/reauth/2fa/otp' + param
            return self._lr_object._put_json(url, payload)
        ...
        def reAuthByPassword(self, access_token, password, smstemplate2fa=''):
            ...
            url = self._lr_object.SECURE_API_URL + \
                authEndpoint + 'account/reauth/password' + param
            return self._lr_object._put_json(url, payload)
